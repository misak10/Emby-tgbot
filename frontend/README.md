# Telegram Mini Apps For AuroraMedia
...
- [Platform documentation](https://docs.telegram-mini-apps.com/zh/)
- [@telegram-apps/sdk-react documentation](https://docs.telegram-mini-apps.com/zh/packages/telegram-apps-sdk-react/2-x)
